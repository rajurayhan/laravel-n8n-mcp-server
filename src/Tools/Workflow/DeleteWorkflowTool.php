...
{
    protected string $name = 'delete-n8n-workflow';

    public function description(): string
    {
        return 'Permanently delete an n8n workflow by ID. This action is irreversible.';
    }
    ...
    public function handle(Request $request): Response|ResponseFactory
    {
        ...
        try {
            $result = N8nClient::workflows()->delete($validator->validated()['workflowId']);
